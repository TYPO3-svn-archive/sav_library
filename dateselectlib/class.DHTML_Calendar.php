...
class DHTML_Calendar {
    ...
    function DHTML_Calendar($calendar_lib_path ='',
                            $lang              = 'en',
                            $theme             = 'calendar-win2k-2',
                            $stripped          = true) {
    ...
    function get_load_files_code() {
        $htmlArray = array();
        $htmlArray[] = '<link rel="stylesheet" type="text/css" media="all" href="' .
                   $this->calendar_lib_path . $this->calendar_theme_file .
                   '" />';
        $htmlArray[] = '<script type="text/javascript" src="' .
        ...
        $htmlArray[] = '<script type="text/javascript" src="' .
                   ...
                   '"></script>';
        return implode(chr(10).chr(9), $htmlArray);
    }
