...
class ux_tx_kickstarter_modfunc1 extends tx_kickstarter_modfunc1 {
...
//		return '</form>'.$this->pObj->doc->section('Kickstarter wizard',$content,0,1).'<form>';
		return $this->pObj->doc->section('Kickstarter wizard',$content,0,1);
	}
...
class ux_tx_kickstarter_modfunc2 extends tx_kickstarter_modfunc2 {
