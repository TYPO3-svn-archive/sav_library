...
require_once($pathKickstarter . 'sections/class.tx_kickstarter_section_tables.php');
require_once($pathKickstarter . 'sections/class.tx_kickstarter_section_pi.php');
